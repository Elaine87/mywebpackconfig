...
! function (e, t) {
  ...
  return function (e) {
      ...
      A = function () {
        ...
        return r(e, [{
          ...
          value: function () {
            ...
            let e = this.option.defaultPlugins,
              t = {
                system: {
                  proto: O['default'],
                  name: 'System'
          ...
          value: function () {
            ...
            let t = v['default'].one('.vc-switch', this.$dom),
            ...
            if (a && a.content) {
              let r = a.content.match(/initial\-scale\=\d+(\.\d+)?/),
          ...
          value: function () {
            ...
            let o = v['default'].one('.vc-content', e.$dom),
              n = !1;
          ...
          value: function (e) {
            ...
            e.vConsole = this, e.trigger('init'), e.trigger('renderTab', function (o) {
              t.tabList.push(e.id);
              let n = v['default'].render(g['default'], {
                id: e.id,
                name: e.name
              });
              v['default'].one('.vc-tabbar', t.$dom).insertAdjacentElement('beforeend', n);
              let i = v['default'].render(m['default'], {
                id: e.id
              });
          ...
          value: function (e) {
            e = (e + '').toLowerCase();
            let t = this.pluginList[e];
            if (void 0 === t) {
              return console.debug('Plugin ' + e + ' does not exist.'), !1;
            }
            if (t.trigger('remove'), this.isInited) {
              let o = v['default'].one('#__vc_tab_' + e);
              o && o.parentNode.removeChild(o);
              for (let n = v['default'].all('.vc-topbar-' + e, this.$dom), i = 0; i < n.length; i++) {
                n[i].parentNode.removeChild(n[i]);
              }
              let a = v['default'].one('#__vc_log_' + e);
              a && a.parentNode.removeChild(a);
              for (let r = v['default'].all('.vc-tool-' + e, this.$dom), l = 0; l < r.length; l++) {
                r[l].parentNode.removeChild(r[l]);
              }
            }
            let c = this.tabList.indexOf(e);
          ...
          value: function () {
            if (this.isInited) {
              ...
              t.style.display = 'block', setTimeout(function () {
                ...
                let t = v['default'].one('.vc-mask', e.$dom);
          ...
          value: function () {
            if (this.isInited) {
              ...
              let e = v['default'].one('.vc-mask', this.$dom),
                t = v['default'].one('.vc-panel', this.$dom);
          ...
          value: function () {
            if (this.isInited) {
              let e = v['default'].one('.vc-switch', this.$dom);
          ...
          value: function (e) {
            if (this.isInited) {
              let t = v['default'].one('#__vc_log_' + e);
              ...
              let o = v['default'].all('.vc-topbar-' + e, this.$dom);
          ...
          value: function () {
            if (this.isInited) {
              for (let e = Object.keys(this.pluginList), t = e.length - 1; t >= 0; t--) {
    ...
    function b(e) {
      ...
      let t = ['toString', 'toLocaleString', 'valueOf', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'constructor'],
        o = [];
      for (let n in e) {
    ...
    l.one = function (e, t) {
      ...
      e && e.addEventListener(t, function (t) {
        let i = l.all(o, e);
        if (i) {
          e: for (let a = 0; a < i.length; a++) {
            for (let r = t.target; r;) {
              if (r == i[a]) {
                n.call(r, t);
                break e;
              }
    ...
    function d(e, t, o, n) {
      ...
      if (e.styleSheet) {
        ...
        let a = document.createTextNode(i),
          r = e.childNodes;
      ...
      return n(o, t),
        function (e) {
          ...
          for (var r = 0; r < a.length; r++) {
            var c = a[r];
            if (0 === c.refs) {
              for (let d = 0; d < c.parts.length; d++) {
                c.parts[d]();
              }
              delete f[c.id];
            }
    ...
    let c = function () {
      ...
      _ = function (e) {
        function t() {
          ...
          let l = r(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n)));
        ...
        return l(t, e), c(t, [{
          ...
          value: function () {
            ...
            s(Object.getPrototypeOf(t.prototype), 'onReady', this).call(this), u['default'].bind(u['default'].one('.vc-cmd', this.$tabbox), 'submit', function (t) {
              t.preventDefault();
              let o = u['default'].one('.vc-cmd-input', t.target),
                n = o.value;
          ...
          value: function (e) {
            ...
            let a = window.__vConsole_cmd_result,
      ...
      k = function (e) {
        ...
        return l(t, e), s(t, [{
          ...
          value: function () {
            let e = this;
            e.isReady = !0;
            let t = f['default'].all('.vc-subtab', e.$tabbox);
            f['default'].bind(t, 'click', function (o) {
              if (o.preventDefault(), f['default'].hasClass(this, 'vc-actived')) {
                return !1;
              }
          ...
          value: function () {
            if (this.isReady) {
              for (; this.logNumber > this.maxLogNumber;) {
                let e = f['default'].one('.vc-item', this.$tabbox);
                if (!e) {
                  break;
                }
          ...
          key: 'showLogType',
          value: function (e) {
            let t = f['default'].one('.vc-log', this.$tabbox);
          ...
          key: 'scrollToBottom',
          value: function () {
            let e = f['default'].one('.vc-content');
          ...
          value: function (e, t) {
            let o = this;
            if (!t) {
              let n = u.JSONStringify(e),
                i = n.substr(0, 26);
              t = u.getObjName(e), n.length > 26 && (i += '...'), t += ' ' + i;
            }
            let a = f['default'].render(y['default'], {
              outer: t,
              lineType: 'obj'
            });
            return f['default'].bind(f['default'].one('.vc-fold-outer', a), 'click', function (t) {
              ...
              let n = f['default'].one('.vc-fold-inner', a);
              if (0 == n.children.length && e) {
                for (let i = u.getObjAllKeys(e), r = 0; r < i.length; r++) {
                  let l = e[i[r]],
                    c = 'undefined',
                    s = '';
    ...
    let n = function () {
      ...
      i = function () {
        function e(t) {
          let n = arguments.length <= 1 || void 0 === arguments[1] ? 'newPlugin' : arguments[1];
      ...
      h = function (e) {
        ...
        return l(t, e), c(t, [{
          ...
          value: function () {
            ...
            let c = e.toLowerCase().match(/ nettype\/([^ ]+)/g);
            t = 'Unknown', c && c[0] ? (c = c[0].split('/'), t = c[1], r += ', ' + t, console.info('[system]', 'Network:', r)) : console.info('[system]', 'Protocol:', r), console.info('[system]', 'UA:', e), setTimeout(function () {
              let e = window.performance || window.msPerformance || window.webkitPerformance;
              if (e && e.timing) {
                let t = e.timing;
    ...
    let c = function () {
      ...
      w = function (e) {
        ...
        return l(t, e), c(t, [{
          ...
          key: 'scrollToBottom',
          value: function () {
            let e = d['default'].one('.vc-content');
          ...
          value: function (e, t) {
            ...
            if (this.reqList[e] = n, this.isReady) {
              ...
              let l = d['default'].render(_['default'], a),
                c = this.domList[e];
              ...
              let s = Object.keys(this.reqList).length;
          ...
          value: function () {
            ...
            if (e) {
              ...
              t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                ...
                let c = e.onreadystatechange || function () {},
                  s = function () {
                    let o = t.reqList[r] || {};
                    if (o.readyState = e.readyState, o.status = 0, e.readyState > 1 && (o.status = e.status), o.responseType = e.responseType, 0 == e.readyState) {
                      ...
                      o.header = {};
                      for (let n = e.getAllResponseHeaders() || '', i = n.split('\n'), a = 0; a < i.length; a++) {
                        let s = i[a];
                        if (s) {
                          let d = s.split(': '),
                            u = d[0],
        ...
        return l(t, e), c(t, [{
                ...
                onClick: function (e) {
                  if (t.activedElem) {
                    if (b['default'].hasClass(t.activedElem, 'vc-toggle')) {
                      for (let o = 0; o < t.activedElem.childNodes.length; o++) {
                        let n = t.activedElem.childNodes[o];
          ...
          value: function () {
            if (!this.isInited) {
              ...
              let e = this.renderView(this.node, b['default'].one('.vc-log', this.$tabbox)),
              ...
              for (let n = 0; n < e.addedNodes.length; n++) {
                ...
                if (a) {
                  if (null !== e.nextSibling) {
                    let r = e.nextSibling.__vconsole_node;
          ...
          value: function (e) {
            let t = e.target.__vconsole_node;
          ...
          value: function (e, t, o) {
            ...
            switch (e.view = i, b['default'].delegate(i, 'click', '.vcelm-node', function (t) {
              ...
              if (!b['default'].hasClass(o, 'vcelm-noc')) {
                ...
                for (let i = -1, a = 0; a < o.children.length; a++) {
                  let r = o.children[a];
            ...
            if (!this._isIgnoredElement(e)) {
              ...
              if (t.childNodes = [], e.childNodes.length > 0) {
                for (let n = 0; n < e.childNodes.length; n++) {
                  let i = this.getNode(e.childNodes[n]);
    ...
    function r(e) {
      let t = ['br', 'hr', 'img', 'input', 'link', 'meta'];
      ...
      b = function () {
        ...
        return s(e, [{
          ...
          value: function (e, t) {
            ...
            let i = g['default'].render(u['default'], {
                node: e
              }),
        ...
        return l(t, e), c(t, [{
          ...
          value: function () {
            if (this.currentType && window.confirm) {
              let e = window.confirm('Remove all ' + this.typeNameMap[this.currentType] + '?');
              if (!e) {
                return !1;
              }
            }
          ...
          value: function () {
            ...
            let t = m['default'].one('.vc-log', this.$tabbox);
            if (0 == e.length) {
              t.innerHTML = '';
            } else {
              for (let o = 0; o < e.length; o++) {
          ...
          value: function () {
            if (document.cookie && navigator.cookieEnabled) {
              for (let e = this.getCookieList(), t = 0; t < e.length; t++) {
