...
let Zepto = function () {
  ...
  return w.matches = function (a, b) {
    ...
    let c = a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.matchesSelector;
    if (c) {
      return c.call(a, b);
    }
    let d, e = a.parentNode,
      f = !e;
    ...
    not: function (b) {
      ...
      if (A(b) && b.call !== a) {
        ...
        let e = typeof b == 'string' ? this.filter(b) : E(b) && A(b.item) ? f.call(b) : c(b);
    ...
    offset: function () {
      ...
      let a = this[0].getBoundingClientRect();
      return {
    ...
    c.fn[a] = function () {
      let a = c.map(arguments, function (a) {
...
window.Zepto = Zepto, '$' in window || (window.$ = Zepto),
    ...
    function k(b, d, e, g, i, k) {
      ...
      j(d, e, function (c, d) {
        let e = i && i(d, c),
          f = e || d,
          j = function (a) {
            let c = f.apply(b, [a].concat(a.data));
    ...
    a.fn.delegate = function (b, c, d) {
      ...
      return this.each(function (f, g) {
        k(g, c, d, b, function (c) {
          return function (d) {
            let e, f = a(d.target).closest(b, g).get(0);
            if (f) {
      ...
      let c = document.createEvent(e[a] || 'Events'),
        d = !0;
      if (b) {
  ...
  function ($) {
    ...
    $.active = 0, $.ajaxJSONP = function (a) {
      ...
      let async = 'async' in settings ? settings.async : !0;
